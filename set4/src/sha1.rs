//https://github.com/hamidrezakp/SHA1/blob/master/src/lib.rs
#[derive(Debug, Eq, PartialEq)]
pub struct Block {
    bytes: Vec<u8>,
}
use super::break_sha1_mac_length_extension::my_padding;
...
pub fn compute_with_registers(blocks: Vec<Block>, h: [u32; 5]) -> Result<String, &'static str> {
    compute_internal(blocks, h)
}
...
fn compute_internal(blocks: Vec<Block>, mut h: [u32; 5]) -> Result<String, &'static str> {
...
mod tests {
    ...
    fn test_pad() {
        ...
        let paded_message = Block::from_message(&my_padding(&message)).unwrap();
    ...
    fn test_pad_message() {
        ...
        let paded_message = Block::from_message(&my_padding(message.as_slice())).unwrap();
